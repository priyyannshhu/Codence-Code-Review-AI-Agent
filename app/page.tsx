  ...
  return (
    <div className=''>
      <header className='flex justify-between items-center'>
        <h1 className='text-3xl font-bold'>Codence – Code Review AI Agent</h1>
      </header>

      <div className='page-container'>
        <h2 className='text-xl font-bold'>
          Welcome to Codence, your intelligent code review assistant.
        </h2>
        <p>
          Codence analyzes your codebase for potential improvements including security, performance, and readability insights — all powered by AI.
        </p>
        <ReviewClient
          files={data?.files || []}
